...
export const METHODOLOGY_NOTES = [
  { id: 'five-dimensions', title: 'Why five weighted dimensions, and why this weighting',
    body: 'Governance Maturity is a weighted average of five sub-dimensions (Ownership & Accountability 20%, Inventory & Visibility 20%, Risk Classification 20%, Controls & Evidence 25%, Monitoring & Response 15%), not a flat percentage of every question answered. The five-dimension taxonomy is independently corroborated by Superblocks\' own "five AI governance failure modes," which map one-to-one onto it. Controls & Evidence carries the highest weight because it is what an auditor actually tests -- backed by two independent sources: ISO 42001 audit-practice reporting and Superblocks\' documented "governance theater" failure mode.' },
  { id: 'gating-rule', title: 'Why a bottom-tier Ownership & Accountability score caps the overall score',
    body: 'A CSA whitepaper found 73% of organizations report internal conflict over who owns AI governance, and 96% of the people handed that responsibility get it without real authority to act. That evidence shows Ownership & Accountability behaving as a structural prerequisite the other four dimensions depend on, not just one-fifth of a flat average -- so a bottom-tier score there caps the overall Governance Maturity score regardless of how the other four dimensions score, and independently qualifies as this tool\'s one critical-severity, dimension-level finding.' },
  { id: 'four-tier-risk-model', title: 'Basis for the four-tier per-use-case risk model',
    body: 'The New AI Tool Adoption assessment\'s four-tier structure and seven classification criteria were already sector-agnostic and did not need adapting. The original Tier 1/2 trigger ("regulatory capital") was a banking-only concept that does not survive leaving financial services, so this tool uses the EU AI Act\'s Annex III high-risk domains instead. Oversight expectations are looked up by (tier x company size), not applied as one universal column, crossed against a size-band table (1-10 owner-led informal, 11-50 exec review, 51-200 formal board + part-time compliance role, 201-1000 dedicated governance role + board committee, 1000+ full governance function) -- an independently-built SMB framework found only 1.5% of surveyed organizations believe they have adequate governance headcount, and solves it by distributing ownership onto existing roles rather than standing up new committees, which is why Tier 2 and Tier 3 oversight expectations are merged for organizations under about 200 employees. This is a structural design choice grounded in that framework, not a claim about what share of real-world AI use cases actually falls into each tier -- no measured prevalence data backs a tier-distribution claim, and this tool does not assert one.' },
  { id: 'why-nist', title: 'Why NIST AI RMF is the spine, not ISO 42001 or the EU AI Act alone',
    body: 'NIST AI RMF is free, is the US reference standard, is sector-agnostic (it works across every industry this tool covers without licensing), and crosswalks to both ISO 42001 and the EU AI Act -- it is also what Big 4 consulting practices actually use as a base. The alternatives each have a disqualifying problem for a tool like this one: ISO 42001 is paywalled and certification-oriented, the EU AI Act is jurisdiction-specific, and Big 4 proprietary frameworks are not licensable for a tool built outside those firms.' },
  { id: 'differentiation', title: 'How this compares to published Big 4 frameworks',
    body: 'A direct review of Deloitte, KPMG, EY, and PwC\'s published AI governance materials found real structural differences worth knowing -- Deloitte actually runs two distinct structures under one brand, KPMG\'s 10-pillar framework is the most consistently documented, EY\'s approach is genuinely fragmented across several numbered structures, and PwC\'s "maturity staging" is a survey-segmentation lens, not a prescriptive model with advancement criteria. The most consequential finding, though: none of the four -- not even Deloitte -- publish anything resembling this tool\'s weighted, gated, and fully documented scoring methodology. That is a real, sourced differentiation point, not a marketing claim.' },
  { id: 'visibility-taxonomy', title: 'The functional-visibility taxonomy is a project-specific construct',
    body: 'The four-tag taxonomy that routes item-bank questions by vantage point (strategic / operational / technical-build / legal-compliance) was validated against real AI-governance-specific org-design sources (Elevate Consult\'s AI Governance Operating Model & RACI framework, Knostic.ai\'s AI Governance Roles and Responsibilities primer). It is explicitly NOT supported by, and should never be cited alongside, the academic "Information Visibility Scale" (ter Hoeven, Stohl, Leonardi & Stohl, 2021, Management Communication Quarterly) -- that instrument measures a genuinely different construct (Availability/Approval/Accessibility of general information visibility) and does not distinguish strategic/operational/technical/compliance levels at all. This taxonomy is this project\'s own org-design construct, not an application of published academic research.' }
];
